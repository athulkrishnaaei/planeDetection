...
#define NODE_MAIN_LOGGER_NAME "octomap_saver_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "liboctomap_saver.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<octomap_server::OctomapSaver>";
